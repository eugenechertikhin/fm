...
WindowMove::WindowMove(int y, int x, int r, int c) {
    Colors::initColors();
    startx = x - c/2;
    starty = y - r/2;
    rows = r;
...
bool WindowMove::draw(int colour) {
    this->colour = colour;
    ...
    mvwprintw(win, 0, 2, " Move ");
    mvwprintw(win, 1, 2, "Move from:");
    mvwprintw(win, 2, 2, "_");
